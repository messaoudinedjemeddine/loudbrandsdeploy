...
async function createUsers() {
  try {
    console.log('👥 Creating specific users for dashboards...');
    ...
    console.log('   Admin: /admin/dashboard/admin');
    console.log('   Confirmatrice: /admin/dashboard/confirmatrice');
    console.log('   Agent Livraison: /admin/dashboard/agent_livraison');
